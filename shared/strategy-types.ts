...
export function normalizeArchetype(input: string): StrategyArchetype {
  ...
  const aliases: Record<string, StrategyArchetype> = {
    ...
    // Additional volatility/breakout variants for Strategy Lab generated bots
    "ib_break": "breakout",
    "ib_break_volexp": "breakout",
    "ib_breakout": "breakout",
    "ib_vol": "breakout",
    "ib_vol_squeeze": "breakout",
    "ib_vol_squeezebreak": "breakout",
    "volcompress": "breakout",
    "volcompress_break": "breakout",
    "volcompress_breakexp": "breakout",
    "volbox": "breakout",
    "volbox_break": "breakout",
    "volbox_breakexp": "breakout",
    "volcompression_bo": "breakout",
    "volcompression_breakout": "breakout",
    "nr7_vol": "breakout",
    "nr7_volexp": "breakout",
    "nr7_volexp_break": "breakout",
    "nr7_breakout": "breakout",
    "squeezebreak": "breakout",
    "squeeze_break": "breakout",
    "breakexp": "breakout",
    "break_exp": "breakout",
    "volexp": "breakout",
    "vol_exp": "breakout",
    "volexp_break": "breakout",
    // Reversal/optimization variants
    "opt_optimized_rev": "reversal",
    "optimized_rev": "reversal",
    "optimized_reversal": "reversal",
    "opt_rev": "reversal",
    "rev": "reversal",
    // Additional IB/Vol variants that couldn't be inferred
    "optvolbreak": "breakout",
    "opt_vol_break": "breakout",
    "ib_volbreak": "breakout",
    "ib_volbreak_retest": "breakout_retest",
    "volbreak": "breakout",
    "volbreak_retest": "breakout_retest",
